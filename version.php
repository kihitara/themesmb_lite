...
$plugin->version   = 2012102500; // The current module version (Date: YYYYMMDDXX)
...
$plugin->release = '1.1.5 (Build: 2012102500)';
$plugin->component = 'theme_themesmb_lite'; // Full name of the plugin (used for diagnostics)